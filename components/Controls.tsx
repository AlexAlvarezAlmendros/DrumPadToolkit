...
import { PlayIcon, StopIcon, TrashIcon, PlusIcon, PauseIcon, PlusCircleIcon, MinusCircleIcon } from './icons/EditorIcons';
import { MIN_BPM, MAX_BPM, SUPPORTED_STEP_COUNTS, DEFAULT_NUM_STEPS } from '../constants';
