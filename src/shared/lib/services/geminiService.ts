...
import { DrumMachineSound, StepState } from '../../../entities/Pattern/model/types';
import { LanguageCode } from '../../model/types';
import { GEMINI_MODEL_NAME, INSTRUMENTS_ORDER, MIN_BPM, MAX_BPM, DEFAULT_NUM_STEPS, DEFAULT_LANGUAGE } from '../../config/constants';
